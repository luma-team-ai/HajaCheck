...
export function MapLegend() {
  ...
  return (
    <div className="absolute bottom-4 left-4 flex items-center gap-3 rounded-full border border-[#d4d4d8] bg-white/90 px-4 py-2 text-xs shadow-sm backdrop-blur-[2px]">
