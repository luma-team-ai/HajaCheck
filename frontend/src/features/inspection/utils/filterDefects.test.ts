...
describe('filterDefects', () => {
  const mockDefects: Defect[] = [
    { id: 1, type: '균열', grade: 'A', status: '신규', confidence: 0.9, bbox: { x: 0, y: 0, width: 0.1, height: 0.1 }, widthMm: 2, lengthMm: 20, summary: '균열 요약 1' },
    { id: 2, type: '박리박락', grade: 'B', status: '신규', confidence: 0.7, bbox: { x: 0, y: 0, width: 0.1, height: 0.1 }, areaRatio: 0.08, summary: '박리박락 요약 2' },
    { id: 3, type: '철근노출', grade: 'C', status: '신규', confidence: 0.5, bbox: { x: 0, y: 0, width: 0.1, height: 0.1 }, areaRatio: 0.05, summary: '철근노출 요약 3' },
    { id: 4, type: '철근노출', grade: 'D', status: '신규', confidence: 0.3, bbox: { x: 0, y: 0, width: 0.1, height: 0.1 }, areaRatio: 0.15, summary: '철근노출 요약 4' },
    { id: 5, type: '박리박락', grade: 'E', status: '신규', confidence: 0.1, bbox: { x: 0, y: 0, width: 0.1, height: 0.1 }, areaRatio: 0.02, summary: '박리박락 요약 5' },
  ];
