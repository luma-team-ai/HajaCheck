...
import { FacilityCardGrid } from './FacilityCardGrid';
...
describe('FacilityCardGrid', () => {
  it('로딩 상태: isLoading이면 로딩 문구를 표시하고 카드는 렌더링하지 않는다', () => {
    render(
      <FacilityCardGrid
  ...
  it('데이터 상태: facilities가 있으면 각 카드를 렌더링한다', () => {
    render(
      <FacilityCardGrid
  ...
  it('카드를 클릭하면 onSelectFacility가 해당 시설물 id로 호출된다', () => {
