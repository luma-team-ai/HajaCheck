...
// 이 페이지는 AI브리핑 위젯을 그대로 재사용하는데, 그 위젯 내용 자체는 DashboardPage 쪽에서
// 이미 검증하므로 여기선 스텁으로 대체(DashboardPage.test.tsx와 동일 패턴). 처리 대기
// (PendingPriorityCard)는 이 페이지 목적과 무관해 제거됐다(#1517).
