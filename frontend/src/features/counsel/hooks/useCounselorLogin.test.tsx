...
describe('useCounselorLogin', () => {
  ...
  // #1703 / PR #1708 2차 P1 — clearPreviousUserLocalState 도입 전에는 useCounselorLogin이 점검
  // 생성 폼 임시저장을 지우지 않아, 공용 PC에서 상담원 로그인 전 사용자의 시설물·메모가 그대로
  // 남았다. 최소한 이 훅이 clearPreviousUserLocalState를 호출한다는 사실을 고정한다.
