...
export const mockMenuTree: MenuTreeItem[] = [
  ...
  { code: 'DEFECTS', name: '하자 관리', menuType: 'INTERNAL', iconKey: 'defects', path: '/defects/list', activePathPattern: null, opensNewTab: false, enabled: true, children: [] },
  {
    ...
    children: [
      ...
      { code: 'REPORTS_EDIT', name: '보고서 편집·미리보기', menuType: 'INTERNAL', iconKey: 'reports', path: '/reports', activePathPattern: '/inspections/1/reports', opensNewTab: false, enabled: true, children: [] },
      { code: 'REPORTS_EXPORT', name: 'PDF 내보내기', menuType: 'INTERNAL', iconKey: 'reports', path: '/reports', activePathPattern: '/inspections/1/reports', opensNewTab: false, enabled: true, children: [] },
    ],
  },
  {
    code: 'SUPPORT',
