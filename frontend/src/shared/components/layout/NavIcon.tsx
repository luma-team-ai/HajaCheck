...
// Figma dev-03-01 사이드바 메뉴 아이콘 — Feather 스타일(stroke, 24x24, round cap/join) 인라인 SVG
// 아이콘 라이브러리 의존성 추가 대신 필요한 아이콘만 최소 구성으로 직접 관리
...
function renderPaths(name: Props['name']) {
  switch (name) {
    case 'dashboard':
      return (
        <>
