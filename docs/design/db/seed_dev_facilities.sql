-- 팀 공용 개발 DB(hajacheck_dev) 시설물 더미데이터 시드 (2026-07-21, 전체 검수 후속)
...
-- 멱등: name 기준 NOT EXISTS 가드 — 재실행해도 중복 삽입 없음.
-- type은 프론트 FACILITY_TYPE_OPTIONS(건물/교량/터널/도로/기타)와 일치.
-- owner_id는 hajacheck_dev 기존 팀원 계정(1 정재봉 / 3 대표 / 9 Ketose / 10 이은석 / 11 허남 / 18 황승현).
