...
class Ha25IncrementalMigrationTest {
    ...
    private static PostgreSQLContainer<?> createMigratedContainer() {
        PostgreSQLContainer<?> postgres = new PostgreSQLContainer<>("postgres:16")
                ...
                .withCopyFileToContainer(
                        MountableFile.forClasspathResource(
                                "db/migration/V8__migrate_facilities_to_company.sql"),
                        CONTAINER_ROOT + "V8__migrate_facilities_to_company.sql");
        postgres.start();
        ...
        runPsql(postgres, "V8__migrate_facilities_to_company.sql");
