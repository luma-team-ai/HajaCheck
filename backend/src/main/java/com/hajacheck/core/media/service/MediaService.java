...
public class MediaService {
    ...
    public List<MediaResponse> uploadMedia(Long inspectionId, Long companyId, List<MultipartFile> files) {
     ...
     */
    @Transactional(propagation = Propagation.NOT_SUPPORTED)
    public ThumbnailFile getThumbnail(Long companyId, Long mediaId) {
        Media media = mediaRepository.findById(mediaId)
                .orElseThrow(() -> new BusinessException(ErrorCode.MEDIA_NOT_FOUND));
        try {
            inspectionService.getInspection(companyId, media.getInspectionId());
